...
public class Configure {
	...
	private static String certPassword = "1236624702";

	private static String key = "6F5C40FA65F8D4F886E54DCD9544F6C7";
	...
	//9) 支付宝退款
	public static String ALI_REFUND_API = "https://openapi.alipay.com/gateway.do";
	
	//企业转账
	public static String TRANSFER_ACCOUNTS_API = "https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers";
	
	public static String TRANSFER_GETPUBLICKEY_API = "https://fraud.mch.weixin.qq.com/risk/getpublickey";
	
	public static String TRANSFER_PAY_BANK = "https://api.mch.weixin.qq.com/mmpaysptrans/pay_bank";
	/**
	 *
